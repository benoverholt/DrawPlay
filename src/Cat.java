...
public class Cat {
	...
	private static final int MOUTH_WIDTH = HEAD_DIMENSION / 5 * 4;
	// mouth starts about 40% from left edge of head
	private static final int MOUTH_X = HEAD_DIMENSION / 20 * 2;
	...
	public void draw(Graphics g, int catX, int catY) {
		...
		g2.drawString("Let the ruling classes tremble at a Communistic revolution.", catX, catY + HEAD_DIMENSION + 10);
	}
}
